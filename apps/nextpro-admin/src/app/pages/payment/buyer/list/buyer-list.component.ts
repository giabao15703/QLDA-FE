...
import { PaymentBuyerDetailComponent } from '#admin/pages/payment/buyer/detail/buyer-detail.component';
...
@Component({
    standalone: true,
    selector: 'nextpro-admin-payment-buyer-list',
    ...
    imports: [
        ...
        TableComponent,
        FilterComponent,
        PaymentBuyerDetailComponent,
        RouterModule,
    ],
})
export class BuyerPaymentListPage {
    constructor(
        ...
        this.table.config.columns = [
            ...
            {
                name: 'userPayment.user.buyer.companyFullName',
                sort: 'full_name',
                ...
                ctas: [
                    {
                        icon: 'visibility',
                        onClick: (row: I_HistoryPayment) => {
                            this.routeService.goTo({ mode: E_Form_Mode.READ, id: row.id });
                        },
                    },
                ],
            },
