...
const TAB_NAME = 'certificationmanagement';

@Component({
    standalone: true,
    selector: 'nextpro-admin-sicp-certification-management-list',
    templateUrl: './certification-management-list.component.html',
    styleUrl: './certification-management-list.component.scss',
...
export class SicpCertificationManagementListPage {
    constructor(
    ...
    getUserSupplierSicps = async (variables?: I_QueryVariables) => {
        const userSupplierSicps = await this.sicpService.getUserSupplierSicps(
            {
                ...getQueryVariables({ variables: { ...variables, fileFilter: 2 } }),
            },
            { extra: { variables } },
        );
    ...
    getUserSupplierSicpTextEditor = async (variables?: I_QueryVariables) => {
        const userSupplierSicpTextEditor = await this.sicpService.getUserSupplierSicpTextEditor(
            {
                ...getQueryVariables({ variables: { ...variables, sicpTypeFilter: '2' } }),
            },
            { extra: { variables } },
        );
