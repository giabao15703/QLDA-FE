...
const TAB_NAME = 'financialriskmanagement';

@Component({
    standalone: true,
    selector: 'nextpro-admin-sicp-financial-risk-management-list',
    templateUrl: './financial-risk-management-list.component.html',
    styleUrl: './financial-risk-management-list.component.scss',
...
export class SicpFinancialRiskManagementListPage {
    constructor(
    ...
    getUserSupplierSicps = async (variables?: I_QueryVariables) => {
        const userSupplierSicps = await this.sicpService.getUserSupplierSicps(
            {
                ...getQueryVariables({ variables: { ...variables, fileFilter: 4 } }),
            },
            { extra: { variables } },
        );
    ...
    getUserSupplierSicpTextEditor = async (variables?: I_QueryVariables) => {
        const userSupplierSicpTextEditor = await this.sicpService.getUserSupplierSicpTextEditor(
            {
                ...getQueryVariables({ variables: { ...variables, sicpTypeFilter: '4' } }),
            },
            { extra: { variables } },
        );
