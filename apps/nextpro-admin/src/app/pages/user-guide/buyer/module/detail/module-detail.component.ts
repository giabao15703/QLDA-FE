...
const FORM_NAME = 'FORM_ADMIN_USER_GUIDE_BUYER_MODULE';

@Component({
    standalone: true,
    selector: 'nextpro-admin-user-guide-buyer-module-detail',
...
export class UserGuideBuyerModuleDetailComponent {
    constructor(
