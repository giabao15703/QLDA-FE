...
const FORM_NAME = 'FORM_ADMIN_USER_GUIDE_SUPPLIER_COURSE';

@Component({
    standalone: true,
    selector: 'nextpro-admin-user-guide-supplier-course-detail',
    templateUrl: './course-detail.component.html',
    styleUrl: './course-detail.component.scss',
    providers: [FormService],
    imports: [CommonModule, TranslateModule, LoadingComponent, MaterialModules, FormComponent],
})
export class UserGuideSupplierCourseDetailComponent {
    constructor(
