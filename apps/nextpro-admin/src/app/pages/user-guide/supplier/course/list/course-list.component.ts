...
import { UserGuideSupplierCourseDetailComponent } from '../detail/course-detail.component';

const TAB_NAME = 'course';

@Component({
    standalone: true,
    selector: 'nextpro-admin-user-guide-supplier-course-list',
    ...
    imports: [
        ...
        TableComponent,
        FilterComponent,
        UserGuideSupplierCourseDetailComponent,
        RouterModule,
    ],
})
export class UserGuideSupplierCourseListPage {
    constructor(
        ...
        this.table.config.columns = [
            ...
            },
            {
                ...
                label: 'user-guide.profileLevel',
                render(_, __, row) {
                    const lst = row?.coursesprofilefeaturessupplierSet?.edges;
                    let str = '';
                    lst?.forEach((element) => {
