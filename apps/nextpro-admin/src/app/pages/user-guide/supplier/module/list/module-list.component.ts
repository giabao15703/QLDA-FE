...
import { UserGuideSupplierModuleDetailComponent } from '../detail/module-detail.component';

const TAB_NAME = 'module';

@Component({
    standalone: true,
    selector: 'nextpro-admin-user-guide-supplier-module-list',
    ...
    imports: [
        ...
        TableComponent,
        FilterComponent,
        UserGuideSupplierModuleDetailComponent,
        RouterModule,
    ],
    providers: [TableService],
})
export class UserGuideSupplierModuleListPage {
    constructor(
